...
export function ReceiptPrint({ receipt, printId = "receipt-print" }: { receipt: Receipt; printId?: string }) {
  return (
    <div id={printId} className="card overflow-hidden max-w-md mx-auto">
  ...
  return (
    <div className="space-y-4">
      <div
        ...
        style={{ backgroundImage: "linear-gradient(180deg, #fde68a 0%, #f59e0b 40%, #b45309 100%)", boxShadow: "0 18px 40px -16px rgba(146,64,14,0.6), inset 0 1px 0 rgba(255,255,255,0.5)" }}
      >
...
export function ReceiptSuccessMark() {
  return (
    <div className="pop-in flex flex-col items-center py-4">
      <div className="chip-3d flex h-20 w-20 items-center justify-center rounded-full bg-green-100">
        <CheckCircle2 size={48} className="text-green-600" />
      </div>
      <div className="text-xl font-bold text-gray-900 mt-3 emboss">Donation Recorded!</div>
